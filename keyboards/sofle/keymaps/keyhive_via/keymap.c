...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  * `-----------------------------------------/       /     \      \-----------------------------------------'
  *            |      | LALT |LSUPER|LCTRL | / LOWER /       \RAISE \  |RSHIFT| RCLT | LAPT |  ]}  |
  *            |      |      |      |      |/ SPACE /         \ BSPC \ |ENTER |      |      |      |
  *             `----------------------------------'           '------''---------------------------'
  */
  [_QWERTY] = LAYOUT(
    ...
    KC_LSPO,   KC_Z,   KC_X,    KC_C,    KC_V,     KC_B,            KC_MUTE,                 XXXXXXX,           KC_N,     KC_M,  KC_COMM,  KC_DOT, KC_SLSH,  KC_RSPC,
                    KC_LBRC, KC_LALT, KC_LGUI, KC_LCTRL, LT(_LOWER, KC_SPC),     LT(_RAISE, KC_BSPC), RSFT_T(KC_ENT), KC_RCTRL,  KC_RALT, KC_RBRC
  ),
//   /*
//   * COLEMAK_DHM
//   * ,-----------------------------------------.                    ,-----------------------------------------.
