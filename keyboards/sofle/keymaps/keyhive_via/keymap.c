 ...
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *            |      | LALT |LSUPER|LCTRL | / LOWER /       \RAISE \  |LSHIFT| LALT | MENU | LEAD |
 *            |      |      |      |      |/ SPACE /         \ BSPC \ |ENTER |      |      |      |
 *             `----------------------------------'           '------''---------------------------'
 */
[_QWERTY] = LAYOUT(
 ...
 */
[_RAISE] = LAYOUT(
  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, RGB_TOG, RGB_VAI,                     TG(_GAME),             XXXXXXX, XXXXXXX,         KC_LBRACKET, KC_RBRACKET, XXXXXXX,  
