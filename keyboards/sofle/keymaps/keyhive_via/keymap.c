 ...
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *            |      | LALT |LSUPER|LCTRL | / LOWER /       \RAISE \  |LSHIFT|      |      |      |
 *            |      |      |      |      |/ SPACE /         \ BSPC \ |ENTER |      |      |      |
 *             `----------------------------------'           '------''---------------------------'
 */
[0] = LAYOUT(
  ...
  KC_LSFT,  KC_Z,   KC_X,    KC_C,    KC_V,     KC_B,       KC_MUTE,           XXXXXXX,           KC_N,    KC_M, KC_COMM,  KC_DOT, KC_SLSH,  KC_RSFT,
                 XXXXXXX, KC_LALT, KC_LGUI, KC_LCTRL, LT(2, KC_SPC),    LT(3, KC_BSPC), LSFT_T(KC_ENT), XXXXXXX, XXXXXXX,  XXXXXXX
),
/*
 * Game
 * ,-----------------------------------------.                    ,-----------------------------------------.
...
[1] = LAYOUT(
  ...
  XXXXXXX,  KC_LSFT,   KC_Z,    KC_X,    KC_C,    KC_V, KC_TRNS,     XXXXXXX, KC_N,    KC_M, KC_COMM,  KC_DOT, KC_SLSH,  KC_TRNS,
...
[2] = LAYOUT(
  ...
  _______, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                       XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_PIPE,
  _______,  KC_EQL, KC_MINS, KC_PLUS, KC_LCBR, KC_RCBR, _______,     _______, KC_LBRC, KC_RBRC, XXXXXXX, XXXXXXX, KC_BSLS, _______,
...
[3] = LAYOUT(
  ...
  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_CAPS,                       KC_PGDN,             KC_LEFT, KC_DOWN,             KC_RGHT,     XXXXXXX, XXXXXXX,
