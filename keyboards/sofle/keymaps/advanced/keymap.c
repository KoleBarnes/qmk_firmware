 ...
 * '-----------------------------------------|  /       /         \       \   |-----------------------------------------'
 *               | LEAD | LALT |LSUPER|LCTRL | / LOWER /           \ RAISE \  |RSHIFT|LSUPER| RALT | LEAD |
 *               |      |      |      |      |/ SPACE /             \ BSPC  \ |ENTER |      |      |      |
 *               '-----------------------------------'               '------------------------------------'
 */
[_QWERTY] = LAYOUT(
  ...
  SC_LSPO           , KC_Z   , KC_X   , KC_C   , KC_V   , KC_B   , KC_MUTE           ,     XXXXXXX            , KC_N          , KC_M   , KC_COMM, KC_DOT , KC_SLSH,  SC_RSPC,
                               QK_LEAD, KC_LALT, KC_LGUI, KC_LCTL, LT(_LOWER, KC_SPC),     LT(_RAISE, KC_BSPC), RSFT_T(KC_ENT), KC_LGUI, KC_RALT, QK_LEAD
),
...
/* Game
 * .-----------------------------------------.                                .-----------------------------------------.
 * | ESC  |   1  |   2  |   3  |   4  |   5  |----------.    E    .-----------|______|______|______|______|______|______|
 * |------+------+------+------+------+------|  ______  |  < N >  |  ______   |------+------+------+------+------+------|
 * |   `  | Tab  |   Q  |   W  |   R  |   T  |----------|    C    |-----------|______|______|______|______|______|______|
 * |------+------+------+------+------+------|  ______  |  < O >  |  ______   |------+------+------+------+------+------|
 * |   G  |      |   A  |   S  |   F  |   G  |----------|    D    |-----------|______|______|______|______|______|______|
 * |------+------+------+------+------+------|  ______  |  < E >  |  ______   |------+------+------+------+------+------|
 * |      |      |   Z  |   X  |   V  |   B  |----------|    R    |-----------|______|______|______|______|______|______|
 * '-----------------------------------------|  /       /         \       \   |-----------------------------------------'
...
[_GAME] = LAYOUT(
  ...
  KC_GRV , KC_TAB , KC_Q   , KC_W   , KC_E   , KC_R   ,                       _______, _______, _______, _______, _______, _______,
  KC_G   , KC_LSFT, KC_A   , KC_S   , KC_D   , KC_F   ,                       _______, _______, _______, _______, _______, _______,
  XXXXXXX, KC_LCTL, KC_Z   , KC_X   , KC_C   , KC_V   , _______,     _______, _______, _______, _______, _______, _______, _______,
 ...
 * '-----------------------------------------|  /       /         \       \   |-----------------------------------------'
 *               |RGBSAI|RGBHUI|RGBVAI|RGBTOG| /______ /           \ ______\  |  TG1 |______|______|______|
 *               |      |      |      |      |/       /             \       \ |      |      |      |      |
 *               '-----------------------------------'               '------------------------------------'
 */
[_RAISE] = LAYOUT(
  ...
  _______, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, _______,     _______, KC_INS   , LVDH   , LVDL   , LVDR   , LVDE   , _______,
                    RGB_SAI, RGB_HUI, RGB_VAI, RGB_TOG, _______,     _______, TG(_GAME), _______, _______, _______
)
};
